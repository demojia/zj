...
<div class="recipient e_clear">
<div class="recipient_top">
<div class="avatar_send">
<a onmousedown="send_jy_pv2('msg_fx_zp');" target="_blank" href="">
<img src="/wedding/Public/uploads/<?php echo ($icon); ?>" alt="" height="90px" width="74px">
</a>									
</div>
<div class="info">
<div class="status"> 
<a target="_blank" href="" title="<?php echo ($username); ?>"><?php echo ($username); ?></a>
<span>
...
<p><?php echo ($age); ?>岁，
<?php echo ($height); ?>cm，
<?php echo ($w_p); ?>-<?php echo ($w_c); ?>，诚信2星级</p>			 	   	
<p> 
<span>照片：<a onmousedown="send_jy_pv2('msg_fx_zplj');" href="" target="_blank" title="照片" alt="照片" class="a_blue12"><?php echo ($count); ?>张</a></span>
</span> 
<span>珍爱有缘人</span> 
</p>				 	   	
</div>
...
<img src="/wedding/Public/Home/images/safe_icon.jpg" height="15" width="14">&nbsp;&nbsp;<span>安全提示：请不要轻易透露您的联系方式，不要借钱给陌生人。</span>&nbsp;&nbsp;&nbsp;&nbsp;<a class="c_lblue" href="" target="_blank">交友安全提示</a>
</p>

<div class="letters_content send_content">
<dl class="e_clear">
<form action="<?php echo U('Letter/send');?>" method="post">
<input type="hidden" name="name" value="<?php echo ($username); ?>">
<div class="editor">


<div class="textarea">
<textarea name="lecontent" style="border:none;border:1px solid none;width:664px;padding:2px 10px;height:200px;line-height:24px;font-size:14px;color:#666;resize: none;"></textarea>
</div>
</div>
<div class="letters_btn e_clear">
<ul>
<li>
<div class="letters_btn_layer" style="display:none;">
<div class="letters_btn_layer_top"></div>
<div class="letters_btn_layer_content">
<p>一张邮票，同时发送到她的手机和邮箱，让她第一时间免费看信，秒速回复。</p>
</div>
<div class="letters_btn_layer_bottom"></div>
</div>
<a class="mobile_stamps" href=""></a>
</li>
<li>
<div class="letters_btn_layer" style="display:none;">
<div class="letters_btn_layer_top"></div>
...
<div class="head"></div>
<div class="center">
<div class="tips"><p><?php echo ($username); ?></p>对你说,进一步发展吧</div>
<div class="pic">
<a href=""><img src="/wedding/Public/uploads/<?php echo ($icon); ?>" alt=""><span>魅力值10点</span></a>
</div>
