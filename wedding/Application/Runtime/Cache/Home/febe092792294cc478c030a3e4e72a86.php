...
<link href="http://images.zastatic.com/zhenai3/zhenai2015/img/favicon.ico" type="image/x-icon" rel="icon" />
<link href="http://images.zastatic.com/zhenai3/zhenai2015/img/favicon.ico" type="image/x-icon" rel="shortcut icon" />
<link rel="stylesheet" href="css/public2.css" />
<link href="css/global.css" rel="stylesheet" media="screen">
<link href="css/button.css" rel="stylesheet" media="screen">
<link href="css/activity_menu.css" rel="stylesheet" type="text/css"/>

<script src="/wedding/Public/news/js/jquery-1.8.3.min.js"></script>
<script src="/wedding/Public/news/js/sea.js"></script>
<script src="/wedding/Public/news/js/lab.min.js"></script>
<script src="/wedding/Public/news/js/fixcore.js"></script>
<script src="/wedding/Public/news/js/global.js" charset="UTF-8"></script>
<script src="/wedding/Public/news/js/jquery.artdialog.js"></script>
<script src="/wedding/Public/news/js/iframetools.js" type="text/javascript"></script>
<script src="/wedding/Public/news/js/za_dialog.js" type="text/javascript"></script>
<script src="/wedding/Public/news/js/commonoption.js" type="text/javascript"></script>

<meta name="keywords" content=",情感门诊部,红娘,交友,征婚,婚介,婚恋,婚姻,单身,择偶,结婚"/>
<meta name="description" content="红娘专区，珍爱网,全球高成功率的华人征婚中心。征婚，婚介，婚恋，婚姻，单身，择偶，结婚" />
<link href="/wedding/Public/news/css/toolbar_b09f3ea.css" rel="stylesheet" type="text/css"/>
<link href="/wedding/Public/news/css/public_comment_2.css" rel="stylesheet" type="text/css" />
<link href="/wedding/Public/news/css/article.css" rel="stylesheet" media="screen" />
<link rel="stylesheet" href="/wedding/Public/news/css/public_44e62d1.css"/>
<script src="/wedding/Public/news/js/adv_player.js"></script>
<script src="/wedding/Public/news/js/turnpage.js" type="text/javascript"></script>
<script src="/wedding/Public/news/js/commonspecial.js"></script>
...
<header id="jcZAHeader" class="header">
  <section class="frameW top-bar  clearfix">
      ...
      <a class="logo" href="http://www.zhenai.com" title="珍爱网">
      <i></i> 
    </a>
    <p class="ad-word ad-CCTV">相亲无难事，珍爱有红娘</p>
    <div class="tools">
      <ul class="clearfix">
        ...
        <li><a href="http://www.zhenai.com/anquan/" target="_blank" rel="nofollow">安全中心</a></li>
...
<div class="w1200 main clearfix">
  <div class="side_left">
    <!---列表导航 新增于2016-02-18 他她说改版-->
    <div class="article_list_menu">
      <ul>
        <li class="on hot">
          <span class="line"></span>热门
        </li>
       
      </ul>
    </div>
    <!---列表导航-->
    <div class="article_list_section">
      <!--点击了右边的标签以后tag_title 才会显示出来-->
      ...
      <ul class="article_list">
        ...
        <?php foreach ($data as $value): ?>
          ...
          <li>
            <a class="clearfix li_link" href="<?php echo $value->url;?>" target="_blank">
              <span class="article_pic"><img src="<?php echo $value->picUrl;?>"/></span>
              <span class="article_info">
                ...
                <p class="desc">认识一个很能聊得来的女生，见面后就跟我借钱~</p>
              </span>
            </a>
        <?php endforeach ?>
          </li>
   ...
   <!--右侧样式 内容修改于  2016-02-19 他她说改版-->
  <div class="side_right">
    <div class="sidemod article_rec">
      <div class="sidemod_title">推荐好文<span class="line"></span></div>
      <ul class="article_rec_cont arct">
        
          <li><a href="javascript:;">1.2016单身人群现状报告，看看你是黄金单身族吗？</a></li>
        
          <li><a href="javascript:;">2.到底要找什么样的男人，婚姻才能长久幸福？</a></li>
        
          <li><a href="javascript:;">3.老婆非要买一件5万元的婚纱，我该怎样劝她放弃？</a></li>
        
          <li><a href="javascript:;">4.【话题】刚确定恋爱关系，对方就开口借钱，该不该给借？</a></li>
        
          <li><a href="javascript:;">5.月入十万的女生，还要跟男生结婚吗？</a></li>
        
      </ul>
    </div>
    <div class="sidemod article_tag">
      <div class="sidemod_title">热门标签<span class="line"></span></div>
      <div class="sidemod_content clearfix" id="hottags">
         
      </div>
    </div>
<div style="width:288;background:#fff" class="sidemod_title">
        <ul class="article_rec_cont arct">
...
<div class="hot-city">
  <div class="city-wrap frameW">
      ...
      城市：
             <a target="_blank" href="javascript:;">北京</a>
             <a target="_blank" href="javascript:;">上海</a>
             <a target="_blank" href="javascript:;">深圳</a>
             <a target="_blank" href="javascript:;">广州</a>
             <a target="_blank" href="javascript:;">无锡</a>
             <a target="_blank" href="javascript:;">苏州</a>
             <a target="_blank" href="javascript:;">温州</a>
             <a target="_blank" href="javascript:;">杭州</a>
             <a target="_blank" href="javascript:;">宁波</a>
             <a target="_blank" href="javascript:;">福州</a>
             <a target="_blank" href="javascript:;">厦门</a>
             <a target="_blank" href="javascript:;">济南</a>
             <a target="_blank" href="javascript:;">青岛</a>
             <a target="_blank" href="javascript:;">大连</a>
             <a target="_blank" href="javascript:;">沈阳</a>
             <a target="_blank" href="javascript:;">天津</a>
             <a target="_blank" href="javascript:;">郑州</a>
             <a target="_blank" href="javascript:;">合肥</a>
             <a target="_blank" href="javascript:;">武汉</a>
             <a target="_blank" href="javascript:;">长沙</a>
             <a target="_blank" href="javascript:;">重庆</a>
             <a target="_blank" href="javascript:;">成都</a>
             <a target="_blank" href="javascript:;">西安</a>
             <a target="_blank" href="javascript:;">昆明</a>
             <a target="_blank" href="javascript:;">南宁</a>
         </div>
  </div>
</div>
