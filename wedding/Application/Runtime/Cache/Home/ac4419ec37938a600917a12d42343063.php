...
<div class="wrapper frameW clearfix">
	<div class="col-left">
		...
		<div class="in">
			...
			<div class="col-form">
			<label>体重：</label>
			<input type="text" name="weight" style="height:30px;width:160px">
			</div>

			<div class="col-form">
			<label>体型：</label>
			<select name="figure" id="figure" style="height:30px;width:160px">
			...
			<div class="col-form">
			<label>公司：</label>
			<input type="text" name="company" style="height:30px;width:160px">
			</div>

			<div class="col-form">
			<label>血型：</label>
			<input type="text" name="blood" style="height:30px;width:160px">
			</div>

			<div class="col-form">
			<label>民族：</label>
			<input type="text" name="minzu" style="height:30px;width:160px">
			</div>

			<div class="col-form">
			<label>信仰</label>
			<input type="text" name="belief" style="height:30px;width:160px">
			</div>
			...
			<div class="col-form">
			<label>工作：</label>
			<input type="text" name="job" style="height:30px;width:160px">
			</div>
