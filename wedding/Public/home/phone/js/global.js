...
$(function(){
	...
	$('#xiu_area').hover(function() {
		...
		if (!data) {
			seajs.use(["artDialog", "artDialogCss", "commonOption", "za_dialog", "http://images.zastatic.com/zhenai3/zhenai2012/js/widget/topXiou.js"]);
		} else {
...
function appendZhenxin(val){
	...
	seajs.use("http://images.zastatic.com/zhenai3/zhenai2012/css/micro_payment.css", function() {
		art.dialog({
			title:'购买服务',
			padding:'0px',
			fixed:false,
